 ...
 * <p/>
 * Use {@link com.ura.casemgt.core.specification.AbstractSpecification} as base for creating specifications, and
...
public interface Specification<T> {
     ...
     */
    boolean isSatisfiedBy(T t) throws IllegalArgumentException; //change to the correct exception;
